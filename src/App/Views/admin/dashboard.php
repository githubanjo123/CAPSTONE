    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-800 text-accent-500 py-8 mb-8">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <button onclick="showLogoutModal()" class="bg-transparent border-2 border-accent-500 text-accent-500 px-6 py-2 rounded-full hover:bg-accent-500 hover:text-primary-600 transition-all duration-300 text-lg font-semibold">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="sticky top-0 z-40 bg-secondary-50 border-b-2 border-secondary-200 mb-0">
            <div class="flex space-x-1">
                <button class="bg-accent-500 text-primary-600 font-semibold px-8 py-5 rounded-t-lg border-b-2 border-primary-600 hover:bg-accent-600 transition-all duration-300 text-lg" id="users-tab" onclick="showTab('users')">
        ...
        <!-- Tab Content -->
        <div class="bg-accent-500 rounded-b-lg p-10 shadow-lg">
            <!-- Tab 1: Manage Users -->
        ...
        <div class="bg-accent-500 rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 transform transition-all duration-300">
            <div class="text-center">
                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-yellow-100 mb-6">
                    <i class="fas fa-sign-out-alt text-2xl text-yellow-600"></i>
                </div>
                <h3 class="text-2xl font-bold text-primary-600 mb-4">Confirm Logout</h3>
                <p class="text-lg text-secondary-600 mb-8">Are you sure you want to logout from the admin panel?</p>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="<?= dirname($_SERVER['SCRIPT_NAME']) ?>/admin/logout" 
                       class="flex-1 bg-red-500 hover:bg-red-600 text-accent-500 font-semibold py-3 px-6 rounded-lg transition-all duration-300 text-center">
